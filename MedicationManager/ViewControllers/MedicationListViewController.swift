...
class MedicationListViewController: UIViewController {
    ...
    @IBAction func surveyButtonTapped(_ sender: Any) {
        guard let moodSurveyVC = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(identifier: "moodSurveyVC") as? MoodSurveyViewController else { return }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        } else if segue.identifier == "toMedication" {
